...
volatile wiced_bool_t _flag_vibration = WICED_FALSE;   //Bandera de evento de vibraci�n
...
//         printf("<<%s\n",second_split);
        ...
        while(second_split!=NULL){
            ...
            case 1:
                ...
                //Si el tipo de acarreo es carga o descarga, levanta bandera de aceler�metro
